...
class QuizRandomizationTests(AuthDisabledTestCase):
    ...
    def test_randomized_questions_in_view(self):
        ...
        # This test doesn't use the REST API but the Django view directly
        # We'll just focus on testing the model-level randomization which is more reliable
